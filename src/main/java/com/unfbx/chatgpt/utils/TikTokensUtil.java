...
public class TikTokensUtil {
    ...
    static {
        ...
        modelMap.put(ChatCompletion.Model.GPT_3_5_TURBO_0914.getName(), registry.getEncodingForModel(ModelType.GPT_3_5_TURBO));
    ...
    public static int tokens(@NotNull String modelName, @NotNull List<Message> messages) {
        ...
        if (modelName.equals(ChatCompletion.Model.GPT_3_5_TURBO_0613.getName())
                ...
                || modelName.equals(ChatCompletion.Model.GPT_3_5_TURBO_0914.getName())
            ...
            tokensPerMessage = 3;
            tokensPerName = 1;
        }else if(modelName.equals(ChatCompletion.Model.GPT_3_5_TURBO_0613.getName())){
            tokensPerMessage = 4;
            tokensPerName = -1;
    ...
    public static ModelType getModelTypeByName(String name) {
        if (
                ChatCompletion.Model.GPT_3_5_TURBO_0613.getName().equals(name) ||
                        ...
                        ChatCompletion.Model.GPT_3_5_TURBO_0914.getName().equals(name) ||
