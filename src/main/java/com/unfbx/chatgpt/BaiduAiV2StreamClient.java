...
public class BaiduAiV2StreamClient extends BaiduAiV2Client {

    private static final Logger log = LoggerFactory.getLogger(BaiduAiV2StreamClient.class);
    ...
    public void streamChatCompletion(BaiduV2CompletionRequest baiduV2CompletionRequest, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            ...
            try {
                ...
                Request request = (new Request.Builder()).url("https://qianfan.baidubce.com/v2/chat/completions")
    ...
    public static BaiduAiV2StreamClient.Builder builder() {
        return new BaiduAiV2StreamClient.Builder();
    }

    public BaiduAiV2StreamClient(BaiduAiV2StreamClient.Builder builder) {
...
//                    }))
        ...
        super.baiduAiV2Api = (new retrofit2.Retrofit.Builder()).baseUrl("https://qianfan.baidubce.com").client(okHttpClient).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).addConverterFactory(JacksonConverterFactory.create()).build().create(BaiduAiV2Api.class);
    }
    ...
    public static final class Builder {
        ...
        public BaiduAiV2StreamClient.Builder paramInterceptor(RequestParamInterceptor val) {
            this.requestParamInterceptor = val;
            return this;
        }

        public BaiduAiV2StreamClient.Builder okHttpClient(OkHttpClient val) {
        ...
        public BaiduAiV2StreamClient build() {
            return new BaiduAiV2StreamClient(this);
        }
    }
}
